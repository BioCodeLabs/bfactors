...
import numpy as np
import csv
path_positive="pdbs/positive/"
path_negative="pdbs/negative/"
path_results="results/"
csv_heaver=['code', 'group', 'pDockQ', 'ppv','probable interaction?']
csv_data=[]
